...
public class Oval extends Draw {
    ...
    public Oval(Color colore, int thick, Point centro, boolean fill) {
        super(colore, thick);
        this.centro = centro;
        this.fill = fill;
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if(fill == false)
            g.drawOval((int)(centro.getX() - diffx), (int)(centro.getY() - diffy),(int) diffx * 3 ,(int) diffy * 3);
        else
            g.fillOval((int)(centro.getX() - diffx), (int)(centro.getY() - diffy), (int) diffx * 3,(int) diffy * 3);
    }
